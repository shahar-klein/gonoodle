...
d=0
dat=`date '+%A%d%B%Y'`
logD="/root/PP_test_start_at_$dat"
NUMC=100
NUMR=100
...
do
        for (( h=0; h<4; h++ ))
        do
                /root/ws/git/gonoodle/gonoodle -u -c 5.5.5.2 --rp loader_multi -C $NUMC -R $NUMC -M 10 -b 100m -p 12000 -L 5.5.50.0:47998 -l 1400 -f 100 -t $T &
                sleep 4
                ip netns exec $INITIATOR_NS /root/ws/git/gonoodle/gonoodle -u -c 30.30.30.100 --rp initiator -C $NUMC -R 10 -M 1 -b 1k -p 12000 -L :12000 -l 1400 -t $T &
                sleep $TS
        ...
        for (( h=0; h<4; h++ ))
        do
                /root/ws/git/gonoodle/gonoodle -u -c 5.5.5.2 --rp loader_multi -C $NUMC -R $NUMC -M 10 -b 40m -p 12000 -L 5.5.50.0:47998 -l 1400 -f 16 -t $T &
                sleep 4
                ip netns exec $INITIATOR_NS /root/ws/git/gonoodle/gonoodle -u -c 30.30.30.100 --rp initiator -C $NUMC -R 10 -M 1 -b 1k -p 12000 -L :12000 -l 1400 -t $T &
                sleep $TS
                tcpdump_on_initiator $d $P1 $P2
